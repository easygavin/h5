...
define(function (require, exports, module) {
  var page = require('page'),
    ...
    template = require("../../views/digit/detail.html"),
  ...
  var init = function (data, forward) {
    ...
    // 处理返回
    page.setHistoryState({url:"digit/detail", data:params},
      "digit/detail",
      (JSON.stringify(params).length > 2 ? "?data=" + encodeURIComponent(JSON.stringify(params)) : "") + "#digit/detail",
      canBack ? 1 : 0);
  };
  ...
  var showDetails = function (data) {
    ...
    var detailTpl = require('/tpl/digit/detail');
  ...
  var showAllIssue = function () {
    ...
    var detailIssueTpl = require('/tpl/digit/detail_issue');
