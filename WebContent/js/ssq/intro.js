...
define(function (require, exports, module) {
  var page = require('page'),
    ...
    util = require('util'),
    $ = require('zepto'),
    template = require('../../views/ssq/intro.html');
  ...
  var init = function (data, forward) {
    ...
    // 处理返回
    page.setHistoryState({url:"ssq/intro", data:params},
      "ssq/intro",
      (JSON.stringify(params).length > 2 ? "?data=" + encodeURIComponent(JSON.stringify(params)) : "") + "#ssq/intro",
      canBack ? 1 : 0);
