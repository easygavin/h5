define(function (require, exports, module) {
  var $ = require('zepto'), util = require('util'), page = require('page'), _ = require('underscore'), service = require('services/jcz'), view = require('/views/athletics/lottery_list.html');
  var lotteryList = {
    init : function (data, forward) {
      ...
      self.getData();
      self.events();
      page.setHistoryState({url : "jcz/lottery_list", self : this.params}, "jcz/lottery_list", "#jcz/lottery_list" + (JSON.stringify(self.params).length > 2 ? "?data=" + encodeURIComponent(JSON.stringify(self.params)) : ""), self.canBack ? 1 : 0);
    },
